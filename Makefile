...
check:
	...
	$(BAZEL) test $(BAZELFLAGS) --extra_toolchains=@phst_rules_elisp//elisp:emacs_29_toolchain -- //...
	$(BAZEL) test $(BAZELFLAGS) --extra_toolchains=@phst_rules_elisp//elisp:emacs_30_toolchain -- //...
